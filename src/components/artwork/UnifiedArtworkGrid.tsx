...
import { UnifiedArtworkCard, type UnifiedArtwork } from "./UnifiedArtworkCard";
...
export function UnifiedArtworkGrid({ artworks, showFilter = true }: Props) {
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {filtered.map((artwork, i) => (
            <UnifiedArtworkCard key={artwork.id} artwork={artwork} index={i} size="md" />
          ))}
        </motion.div>
      </AnimatePresence>
